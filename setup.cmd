...
:PROCESS_CMD
    ...
    CALL "%utility_folder%..\utils\setup.cmd" cecho 7zip graphviz
    ...
    ENDLOCAL & (
        SET "TOOLSET_DOXYGEN_PATH=%utility_software_folder%"
        SET "PATH=%PATH%"
    )
EXIT /B 0
...
:SHOW_HELP
    ...
    ECHO #     TOOLSET_DOXYGEN_PATH    Absolute path where this tool is        #
    ECHO #         located.                                                    #
    ECHO #                                                                     #
